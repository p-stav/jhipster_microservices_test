...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("microservice1");
        ...
        config.setInstanceName("microservice1");
        ...
        config.getMapConfigs().put("com.example.jhipster.domain.*", initializeDomainMapConfig(jHipsterProperties));
